 ...
 *     description: Users can retrieve all posts.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   get:
 *     summary: Get a post
 *     description: Logged in users can fetch any post in the system.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can only update their own posts.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Users can create comment on post.
 *     tags: [Comments]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
...
/**
 * @swagger
 * /users/{postId}/{commentId}:
 *   patch:
 *     summary: Update a comment
 *     description: Logged in users can only update their own comments.
 *     tags: [Comments]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can delete only their comments.
 *     tags: [Comments]
 *     security:
 *       - bearerAuth: []
 *     parameters:
